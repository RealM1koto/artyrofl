...
iwr "https://raw.githubusercontent.com/RealM1koto/artyrofl/main/song.mp3" -OutFile $script:songPath -UseBasicParsing
[MCI]::Play($script:songPath)

$script:imgPath = "$env:TEMP\bg.jpg"
iwr "https://raw.githubusercontent.com/RealM1koto/artyrofl/main/bug.jpg" -OutFile $script:imgPath -UseBasicParsing
